...
import HeaderDavalyze from "@/components/HeaderDavalyze";
import RelatedDavalyze from "@/components/RelatedDavalyze";
import FooterDavalyze from "@/components/FooterDavalyze";
